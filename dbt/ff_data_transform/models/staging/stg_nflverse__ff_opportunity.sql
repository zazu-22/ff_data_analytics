...
with
    base as (
        select
            ...
            -- Air yards metrics (2 columns - other advanced metrics not in sample
            -- dataset)
            o.pass_air_yards,
            o.rec_air_yards,
        ...
        -- These are unidentifiable players with NULL position and small opportunity
        -- counts (1-4 targets)
    ...
    crosswalk as (
        ...
        -- IDs)
        -- Mapping coverage: 99.86% of identifiable ff_opportunity players map
        -- successfully
        select
    ...
    unpivoted as (
        ...
        select
            ...
            season_type,
            position,
            'pass_completions_exp' as stat_name,
            cast(pass_completions_exp as double) as stat_value,
            'real_world' as measure_domain,
            'actual' as stat_kind,
            'nflverse' as provider
        from crosswalk
        where pass_completions_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'receptions_exp',
            cast(receptions_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where receptions_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(pass_yards_gained_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_yards_gained_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(rec_yards_gained_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rec_yards_gained_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(rush_yards_gained_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rush_yards_gained_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'pass_touchdown_exp',
            cast(pass_touchdown_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_touchdown_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rec_touchdown_exp',
            cast(rec_touchdown_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rec_touchdown_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rush_touchdown_exp',
            cast(rush_touchdown_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rush_touchdown_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(pass_interception_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_interception_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'pass_first_down_exp',
            cast(pass_first_down_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_first_down_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rec_first_down_exp',
            cast(rec_first_down_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rec_first_down_exp is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rush_first_down_exp',
            cast(rush_first_down_exp as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rush_first_down_exp is not null
        ...
        select
            ...
            cast(pass_completions_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_completions_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'receptions_diff',
            cast(receptions_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where receptions_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(pass_yards_gained_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_yards_gained_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(rec_yards_gained_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rec_yards_gained_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(rush_yards_gained_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rush_yards_gained_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'pass_touchdown_diff',
            cast(pass_touchdown_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_touchdown_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rec_touchdown_diff',
            cast(rec_touchdown_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rec_touchdown_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rush_touchdown_diff',
            cast(rush_touchdown_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rush_touchdown_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(pass_interception_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_interception_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(pass_first_down_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_first_down_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rec_first_down_diff',
            cast(rec_first_down_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rec_first_down_diff is not null
        union all
        select
            player_id,
            player_key,
            ...
            cast(rush_first_down_diff as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rush_first_down_diff is not null
        ...
        select
            ...
            position,
            'pass_air_yards',
            cast(pass_air_yards as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_air_yards is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rec_air_yards',
            cast(rec_air_yards as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rec_air_yards is not null
        ...
        select
            ...
            position,
            'pass_attempt',
            cast(pass_attempt as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_attempt is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rec_attempt',
            cast(rec_attempt as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rec_attempt is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rush_attempt',
            cast(rush_attempt as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rush_attempt is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'pass_attempt_team',
            cast(pass_attempt_team as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where pass_attempt_team is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rec_attempt_team',
            cast(rec_attempt_team as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
        where rec_attempt_team is not null
        union all
        select
            player_id,
            player_key,
            ...
            position,
            'rush_attempt_team',
            cast(rush_attempt_team as double),
            'real_world',
            'actual',
            'nflverse'
        from crosswalk
