...
**Note:** For questions involving statistical modeling, machine learning, or simulation design, consider also using the `ff-ml-modeling` or `ff-statistical-methods` skills. For data architecture and pipeline questions, use the `data-architecture-spec1` skill.
...
- Designing marts for trade analysis or roster tracking
- Structuring player valuation pipelines
- Building fact tables for historical performance
- Creating dimensions for player/franchise attributes
